...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-11-2024 a las 12:49:30
...
INSERT INTO `menu` (`id`, `titulo`, `url`, `nivel`, `padre_id`, `orden`, `es_dropdown`, `controlador`, `metodo`) VALUES
...
(7, 'Something else here', '#', 2, 4, 3, 0, NULL, NULL);
