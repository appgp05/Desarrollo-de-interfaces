...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-10-2024 a las 12:17:52
...
('root', '[{\"db\":\"di2024\",\"table\":\"usuarios\"},{\"db\":\"2si\",\"table\":\"menus\"}]');
...
('root', 'di2024', 'usuarios', '{\"sorted_col\":\"`usuarios`.`id_Usuario` DESC\"}', '2024-10-01 10:16:54');
...
('root', '2024-10-01 10:11:58', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
